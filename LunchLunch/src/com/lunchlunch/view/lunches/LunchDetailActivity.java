...
/**
 * An activity representing a single Lunch detail screen. This activity is only
 * used on handset devices. On tablet-size devices, item details are presented
 * side-by-side with a list of items in a {@link LunchListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link LunchDetailFragment}.
 */
...
//		LunchInterface lunch = getIntent().getParcelableExtra("lunch");
		...
		if (savedInstanceState == null) {
			...
			// arguments.putString(LunchDetailFragment.ARG_ITEM_ID, getIntent()
			// .getStringExtra(LunchDetailFragment.ARG_ITEM_ID));
